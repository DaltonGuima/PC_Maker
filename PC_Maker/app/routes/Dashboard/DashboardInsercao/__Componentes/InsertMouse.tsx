                ...
                <Modal.Footer className="bg-black border border-dark" >
                    ...
                    {!error &&
                        <>
                            ...
                            <Link to="/Dashboard/DashboardComponents/ReadMouse">
                        ...
                        <div className="card-body card-block">
                            ...
                            <div className="row">
                                <div className="col">
                                    ...
                                    <input type="text" name="preco" id="preco" placeholder="Preço" className="form-control" required/>
                                ...
                                <div className="col">
                                    ...
                                    <input type="text" name="linkProduto" id="linkProduto" placeholder="Fabricante" className="form-control" required/>
                            ...
                            <div className="row">
                                <div className="col">
                                    ...
                                    <input type="text" name="nbotoes" id="nbotoes" placeholder="Nº de botões" className="form-control" required/>
                                ...
                                <div className="col">
                                    ...
                                    <input type="text" name="sensibilidade" id="sensibilidade" placeholder="DPI" className="form-control" required/>
                                    ...
                                    <div className="form-check">
                                        <div className="checkbox">
                                            <label htmlFor="fio" className="form-check-label ">
                                                <input type="checkbox" id="fio" name="checkbox1" value="semfio" className="form-check-input check" />Sem fio
                                            </label>
                                        </div>
                                    </div>
                                </div>
