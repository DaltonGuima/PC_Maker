...
export function storeAnswer(question_number, event){
...
export function getInfoBasedOnScore(){
    if(totalScore() < 7){
        var score_info;
        score_info = "Você precisa tomar mais cuidado com a segurança!";
...
export function nextQuestion(question_number){
...
export function growProgressBar(percentage_width){
