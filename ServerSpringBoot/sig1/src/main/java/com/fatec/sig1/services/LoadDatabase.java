 ...
 * MantemProdutoRepository repository2,
 ...
 * // Cliente
 * Cliente cliente1 = new Cliente("Jose da Silva", "01/03/1964", "M",
 * "59672555598", "03694000", "2983");
 * cliente1.setEndereco("Aguia de Haia");
 * log.info("Preloading " + repository.save(cliente1));
 * Cliente cliente2 = new Cliente("Nestor José", "19/08/1970", "M",
 * "16467548671", "04280130", "59");
 * cliente2.setEndereco("Rua Frei Joao");
 * log.info("Preloading " + repository.save(cliente2));
 * Cliente cliente3 = new Cliente("Nestordfsadwfgyuwgfuwbfkewafewdijhgerw José",
 * "12/08/1970", "M",
